...
var showHelp=false, helpWidth = 300;

function SetHelpVisibility(v){
	showHelp=v;
	
	if(v){
		changecssproperty(document.getElementById('helpBar'), 'opacity', '1');
		changecssproperty(document.getElementById('helpBar'), 'height', cvn.height-10 + "px");
		changecssproperty(document.getElementById('helpBar'), 'width', "300px");
	}else{
		changecssproperty(document.getElementById('helpBar'), 'opacity', '0');
		changecssproperty(document.getElementById('helpBar'), 'width', "0px");
	}
...
/*function Distance(a, b){var d = a-b;  if(d<0){d*=-1;} return d;}*/
